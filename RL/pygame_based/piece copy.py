...
class Piece(pygame.sprite.Sprite):
    ...
    def getImage(self):
        if (self.id.startswith("r")):
            print("red")
            return pygame.image.load("./images/red.png")
        elif (self.id.startswith("g")):
            print("green")
            return pygame.image.load("./images/green.png")
        elif (self.id.startswith("b")):
            print("blue")
            return pygame.image.load("./images/blue.png")
        else:
            print("yellow")
            return pygame.image.load("./images/yellow.png")
    ...
    def nMove(self, tossValue: int) -> dict:
        ...
        if self.cell == self.station:
            if (tossValue == 1 or tossValue == 6):
                self.__enable()
                return {"tossSpent": True, "reRoll": True}
            return {"tossSpent": False, "reRoll": False}
        else:
            ...
            if (indexOfParentCell > len(self.path) - 1 - tossValue):
                ...
                if (self.path[indexOfParentCell + tossValue].cellType == "home"):
                    ...
                    hasCutPiece = (self.path[indexOfParentCell + tossValue].addPiece(self) == "reset")
                    # if (hasCutPiece):
                    return {"tossSpent": True, "reRoll": hasCutPiece, "hasCutPiece": hasCutPiece}
                    # else:
