...
function nMove(tossValue,piece) {
    ...
    function move(i){
        if (i==goalIndex){
            addPiece(piece,piece.path[i-1]);   
        }
        else{
            sleep(250).then(()=>{
                move(i+1);
                hop(piece,piece.path[i]);
            })
        }
    }
    move(i);
...
function placeDice(){
    ...
    center = document.querySelector("#rgby");

    y = center.getBoundingClientRect().top;
    ...
    // dice.style.size = width+"px";
}

function placeAtStation() {
    pieceStationCombo = 
    [
        {"piece": gp0 ,"station": gp0.cell },
        {"piece": gp1 ,"station": gp1.cell },
        {"piece": gp2 ,"station": gp2.cell },
        {"piece": gp3 ,"station": gp3.cell },

        {"piece": yp0 ,"station": yp0.cell },
        {"piece": yp1 ,"station": yp1.cell },
        {"piece": yp2 ,"station": yp2.cell },
        {"piece": yp3 ,"station": yp3.cell },
        
        {"piece": rp0 ,"station": rp0.cell },
        {"piece": rp1 ,"station": rp1.cell },
        {"piece": rp2 ,"station": rp2.cell },
        {"piece": rp3 ,"station": rp3.cell },

        {"piece": bp0 ,"station": bp0.cell },
        {"piece": bp1 ,"station": bp1.cell },
        {"piece": bp2 ,"station": bp2.cell },
        {"piece": bp3 ,"station": bp3.cell }
        
    ]

    pieceStationCombo.forEach((pair,index)=>{
        hop(pair["piece"],pair["station"]);
        // console.log(index);
    })
